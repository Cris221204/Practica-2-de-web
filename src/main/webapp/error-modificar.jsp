...
<div class="main-content">
  <div class="form-container text-center">
    <div class="alert-error">
      <h2>❌ Error al Modificar Registro</h2>
      <p>Ha ocurrido un error al intentar modificar el registro en la base de datos.</p>
      <p><small>Posibles causas: El ID no existe, datos inválidos o problema de conexión.</small></p>
    </div>
